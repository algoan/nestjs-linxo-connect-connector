...
export class AlgoanHttpService {
  ...
  public async request<T>(config: AxiosRequestConfig): Promise<T> {
    ...
    // RequestBuilder's axios dependency is incompatible with @nestjs/axios
    // Should set axios as peer dependency or update it
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    return this.requestBuilder.request(config as any);
  }
}
